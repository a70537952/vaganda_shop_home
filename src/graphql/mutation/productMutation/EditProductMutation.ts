...
export function useEditProductMutation<TData = any>(
  fragment: DocumentNode,
  options?: MutationHookOptions<
    { editProductMutation: TData },
    EditProductMutationVars
  >
) {
  return useMutation<{ editProductMutation: TData }, EditProductMutationVars>(
    EditProductMutation(fragment),
    options
  );
}
