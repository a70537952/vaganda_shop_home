...
export function useShopNotificationSettingLazyQuery<TData = any>(
  fragment: DocumentNode,
  options?: QueryHookOptions<
    { shopNotificationSetting: TData[] },
    ShopNotificationSettingVars
  >
) {
  return useLazyQuery<
    { shopNotificationSetting: TData[] },
    ShopNotificationSettingVars
  >(shopNotificationSettingQuery(fragment), options);
}

export function useShopNotificationSettingQuery<TData = any>(
  fragment: DocumentNode,
  options?: QueryHookOptions<
    { shopNotificationSetting: TData[] },
    ShopNotificationSettingVars
...
export function shopNotificationSettingQuery(
  fragment: DocumentNode
): DocumentNode {
  return gql`
