...
export function useCreateShopMutation<TData = any>(
  fragment: DocumentNode,
  options?: MutationHookOptions<
    { createShopMutation: TData },
    CreateShopMutationVars
  >
) {
  return useMutation<{ createShopMutation: TData }, CreateShopMutationVars>(
    CreateShopMutation(fragment),
    options
  );
}
