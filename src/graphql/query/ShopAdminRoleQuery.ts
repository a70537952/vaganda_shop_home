...
export function useShopAdminRoleLazyQuery<TData = any>(
  fragment: DocumentNode,
  options?: QueryHookOptions<
    { shopAdminRole: WithPagination<TData> },
    ShopAdminRoleVars
  >
) {
  return useLazyQuery<
    { shopAdminRole: WithPagination<TData> },
    ShopAdminRoleVars
  >(shopAdminRoleQuery(fragment), options);
}

export function useShopAdminRoleQuery<TData = any>(
  fragment: DocumentNode,
  options?: QueryHookOptions<
    { shopAdminRole: WithPagination<TData> },
    ShopAdminRoleVars
  ...
  return useQuery<{ shopAdminRole: WithPagination<TData> }, ShopAdminRoleVars>(
    shopAdminRoleQuery(fragment),
    options
  );
}
