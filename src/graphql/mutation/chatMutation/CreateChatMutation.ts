...
export function useCreateChatMutation<TData = any>(
  fragment: DocumentNode,
  options?: MutationHookOptions<
    { createChatMutation: TData },
    CreateChatMutationVars
  >
) {
  return useMutation<{ createChatMutation: TData }, CreateChatMutationVars>(
    CreateChatMutation(fragment),
    options
  );
}
