...
export function useAddUserOrderDetailCommentMutation<TData = any>(
  ...
  options?: MutationHookOptions<
    { addUserOrderDetailCommentMutation: TData },
    AddUserOrderDetailCommentMutationVars
  >
) {
  return useMutation<
    { addUserOrderDetailCommentMutation: TData },
    AddUserOrderDetailCommentMutationVars
  >(AddUserOrderDetailCommentMutation(fragment), options);
}

export function AddUserOrderDetailCommentMutation(
  fragment: DocumentNode
): DocumentNode {
  return gql`
