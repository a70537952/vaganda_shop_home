...
export interface ProductImageVars {
  created_at?: String;
  updated_at?: String;
  id?: String;
  product_id?: String;
...
export function useProductImageLazyQuery<TData = any>(
  fragment: DocumentNode,
  options?: QueryHookOptions<{ productImage: TData[] }, ProductImageVars>
) {
  return useLazyQuery<{ productImage: TData[] }, ProductImageVars>(
    productImageQuery(fragment),
    options
  );
}

export function useProductImageQuery<TData = any>(
  fragment: DocumentNode,
  options?: QueryHookOptions<{ productImage: TData[] }, ProductImageVars>
) {
  return useQuery<{ productImage: TData[] }, ProductImageVars>(
    productImageQuery(fragment),
    options
  );
}

export function productImageQuery(fragment: DocumentNode): DocumentNode {
  return gql`
    query ProductImage(
      $created_at: String
      $updated_at: String
